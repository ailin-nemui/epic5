 ...
 */
const char irc_version[] = "EPIC4-0.9.13-3";
const char useful_info[] = "epic4 0 9 13";

/*
 * internal_version is what $V returns, its the integer-id for the
 * version, and corresponds to the date of release, YYYYMMDD.
 */ 
const char internal_version[] = "20001207";

/*
 * In theory, this number is incremented for every commit.
 */
const unsigned long	commit_id = 8;
 ...
 */
const char ridiculous_version_name[] = "Mollify";
...
int 	main (int argc, char *argv[])
{
	...
	if (dont_connect)
		...
		get_connected(0, -1);		/* Connect to default server */
