 ...
 */
const char irc_version[] = "EPIC4-0.9.15-3";
 ...
 */ 
const char internal_version[] = "20010112";

/*
 * In theory, this number is incremented for every commit.
 */
const unsigned long	commit_id = 20;
 ...
 */
const char ridiculous_version_name[] = "Intemperate";
