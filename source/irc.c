 ...
 */
const char irc_version[] = "EPIC4-0.9.14-2";
 ...
 */ 
const char internal_version[] = "20001221";

/*
 * In theory, this number is incremented for every commit.
 */
const unsigned long	commit_id = 11;
 ...
 */
const char ridiculous_version_name[] = "Perniscious";
